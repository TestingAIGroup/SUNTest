...
class SurpriseAdequacy:
    ...
    def __init__(self,  model, train_inputs, layer_names, upper_bound, dataset):
        ...
        self.save_path='/home/EI_Neurons/cifar10_convnet/lsa/'
    ...
    def test(self, test_inputs, dataset_name, repeat, seed_selection_strategy, instance='mdsa'):
        ...
        if instance == 'dsa':
            ...
            np.save(self.save_path + 'cifar10_convnet_moon_{}_{}_repeat.npy'.format(seed_selection_strategy, repeat), target_dsa)
        ...
        if instance == 'lsa':
            ...
            np.save(self.save_path + 'cifar10_convnet_moon_lsa_{}_{}_repeat.npy'.format(seed_selection_strategy, repeat),
                    target_lsa)
        ...
        if instance == 'mdsa':
            ...
            target_mdsa = fetch_mdsa(self.model, self.train_inputs, test_inputs,
                                   ...
                                   self.var_threshold, self.save_path, self.dataset)
            np.save(
                self.save_path + 'cifar10_convnet_moon_mdsa_{}_{}_repeat.npy'.format(seed_selection_strategy, repeat),
                target_mdsa)
...
if __name__ == "__main__":
    ...
    seed_selection_strategy = ['Deepgini', 'Random', 'RobotBE', 'RobotBE']
    repeat_times = 5
    file_path = '/home/EI_Neurons/cifar10_convnet/MOON/'
    ...
    for seeds in seed_selection_strategy:
        ...
        for repeat in range(0, repeat_times):
            ...
            load_inps = np.load(file_path + 'MOON_all_gen_inps_{}_strategy_{}_repeat.npz'.format(seeds, repeat),
                                allow_pickle=True)
    ...
    #     for repeat in range(0, repeat_times):
    #         all_gen_inps = []
    #         load_inps = np.load(file_path + 'Adapt_cifar_convnet_adaptive_strategy_{}Seed_NC_all_gen_inps_200_5_{}_repeat.npy'.format(seeds, repeat), allow_pickle=True)
