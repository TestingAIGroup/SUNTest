...
def write2excel(ALL_results, repeat_times, seed_selection_strategy, saved_path):
    ...
    f.save(saved_path + 'MOON_fitC_results_FitnessB_200_5_V2.xls')
...
if __name__ == "__main__":
    ...
    saved_file_path = '/workspace/EI_Neurons/cifar100_resnet/MOON/MOON-FitnessB/'
    ...
    for repeat in range(0, repeat_times):
        ...
        for seed_strategy in seed_selection_strategy:
                ...
                for iteration in range(1, iteration_max + 1):
                    ...
                    if mutated_seed_label != raw_seed_label:
                        ...
                        if not trigger_obj.trigger_input_archive:
                            ...
                            fitness_value = FitnessValue(1)
                        else:
                            print('Found triggering inputs, using fitness B!!')
                        ...
                        if fitness_value.better_than(best_fitness_value):
                            print("update fitness value from {} to {}".format(best_fitness_value, fitness_value.diff_value))
            ...
            np.savez(saved_file_path + 'MOON_all_gen_inps_FitnessB_{}_strategy_{}_repeat_V2.npz'.format(seed_strategy, str(repeat)),
