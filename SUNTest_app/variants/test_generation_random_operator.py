...
from GenSOTA.MOON.dflare_probability_img_mutations import RandomImgMutations as ImgMutations
...
def write2excel(ALL_results, repeat_times, seed_selection_strategy, saved_path):
    ...
    f.save(saved_path + 'MOON_fitC_results_RandomMutation_200_5_V1.xls')
...
if __name__ == "__main__":
    ...
    saved_file_path = '/workspace/EI_Neurons/cifar100_resnet/MOON/MOON-Random-Mutation/'
    ...
    fitness_mode = 'fitC'
    # seed_selection_strategy = ['SUS', 'SUSArt', 'SUSRandomART', 'ATSRandomART', 'ATSUSART', 'SUSClass', 'Random', 'Deepgini', 'RobotBe', 'RobotKM' ]
    seed_selection_strategy = ['Random', 'RobotBe', 'RobotKM', 'Deepgini', 'MCP']
    ...
    for repeat in range(0, repeat_times):
        ...
        for seed_strategy in seed_selection_strategy:
            ...
            np.savez(saved_file_path + 'MOON_all_gen_inps_RandomMutation_{}_strategy_{}_repeat_V1.npz'.format(seed_strategy, str(repeat)),
                     **trigger_obj.all_gen_inps)
            # np.save(saved_file_path + 'MOON_all_gen_triggering_inps_RandomMutation_{}_strategy_{}_repeat_V1.npy'.format(seed_strategy, str(repeat)),
