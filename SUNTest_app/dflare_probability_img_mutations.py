...
class MutationP:
    def __init__(self, m, total=0, delta_bigger_than_zero=0, fault_type_num = 0, trigger_num =0, epsilon=1e-7):
        ...
        self.fault_type_num = fault_type_num
    ...
    def score(self, epsilon=1e-7):
        # mylogger = Logger()
        rate = (self.delta_bigger_than_zero / (self.total + epsilon))*((self.fault_type_num)/ (self.trigger_num + epsilon))
